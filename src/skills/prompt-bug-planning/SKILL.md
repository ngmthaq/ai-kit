---
name: prompt-bug-planning
description: Delegation prompt template from Root Agent to debugger.agent.md. Use when delegating a bug report for fix planning.
---

## Purpose

Delegation prompt template used by the **Root Agent** when sending a bug report to `debugger.agent.md` for fix planning.
